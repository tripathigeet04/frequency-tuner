%run magnitude and phase of the .wav and match with a frequency of 440 Hz
    %phase of 0 degrees....but ignore phase for right now and try to focus
    %more on magnitude
%do an fft on the whole thing
